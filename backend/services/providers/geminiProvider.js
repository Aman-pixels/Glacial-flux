...
async function detectViralMoments(transcriptionData) {
  ...
  const result = await model.generateContent([
    { text: `You are an expert movie/cartoon clip curator for TikTok and YouTube Shorts. Find the top 3-5 most viral cinematic moments (30-60 sec) in this transcript.
